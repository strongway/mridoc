...
A *generic* fMRI preprocessing pipeline looks as follows. **fMRIPrep performs the
blue steps but deliberately stops before spatial smoothing and intensity scaling** —
those are analysis choices you apply later (in your GLM), not part of fMRIPrep's output:
