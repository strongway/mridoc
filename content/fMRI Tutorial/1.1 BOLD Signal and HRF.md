...
> Peak at $t \approx (\alpha_1 - 1)\beta_1 = 5$ s, post-stimulus undershoot at ~15 s. These are the defaults used by SPM, nilearn (`glover_hrf`), and most other neuroimaging packages.
